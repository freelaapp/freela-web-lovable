...
export const servicosPF = [
  ...
  { id: "barman", label: "Barman/Bartender", pricePerHour: 25, minHoursCasa: 6, minHoursEmpresa: 6, insuranceFee: 1 },
  { id: "cozinheiro", label: "Cozinheiro(a)", pricePerHour: 25, minHoursCasa: 6, minHoursEmpresa: 6, insuranceFee: 1 },
  { id: "copeiro", label: "Copeiro(a)", pricePerHour: 20, minHoursCasa: 6, minHoursEmpresa: 6, insuranceFee: 1 },
  { id: "atendente", label: "Atendente", pricePerHour: 20, minHoursCasa: 6, minHoursEmpresa: 6, insuranceFee: 1 },
  { id: "garcom", label: "Garçom/Garçonete", pricePerHour: 25, minHoursCasa: 6, minHoursEmpresa: 6, insuranceFee: 1 },
  { id: "garcom-evento", label: "Garçom/Garçonete (Evento)", pricePerHour: 65, minHoursCasa: 4, minHoursEmpresa: 4, insuranceFee: 1 },
  { id: "bartender-evento", label: "Bartender (Evento)", pricePerHour: 75, minHoursCasa: 4, minHoursEmpresa: 4, insuranceFee: 1 },
  { id: "cozinheiro-evento", label: "Cozinheiro(a) (Evento)", pricePerHour: 75, minHoursCasa: 4, minHoursEmpresa: 4, insuranceFee: 1 },
  { id: "auxiliar-cozinha-evento", label: "Auxiliar de Cozinha (Evento)", pricePerHour: 50, minHoursCasa: 4, minHoursEmpresa: 4, insuranceFee: 1 },
  { id: "copeira-evento", label: "Copeira/Negócio (Evento)", pricePerHour: 50, minHoursCasa: 4, minHoursEmpresa: 4, insuranceFee: 1 },
  { id: "auxiliar-limpeza-evento", label: "Auxiliar de Limpeza (Evento)", pricePerHour: 50, minHoursCasa: 4, minHoursEmpresa: 4, insuranceFee: 1 },
  { id: "recepcionista-corp", label: "Recepcionista (Corporativo)", pricePerHour: 20, minHoursCasa: 6, minHoursEmpresa: 6, insuranceFee: 1 },
  { id: "hostess-corp", label: "Hostess (Corporativo)", pricePerHour: 20, minHoursCasa: 6, minHoursEmpresa: 6, insuranceFee: 1 },
  { id: "promotor-corp", label: "Promotor(a) de Eventos (Corporativo)", pricePerHour: 25, minHoursCasa: 6, minHoursEmpresa: 6, insuranceFee: 1 },
  ...
  { id: "apoio-operacional-corp", label: "Apoio Operacional (Corporativo)", pricePerHour: 20, minHoursCasa: 6, minHoursEmpresa: 6, insuranceFee: 1 },
  { id: "organizacao-filas-corp", label: "Organização das filas (Corporativo)", pricePerHour: 20, minHoursCasa: 6, minHoursEmpresa: 6, insuranceFee: 1 },
  { id: "seguranca-corp", label: "Segurança (Não Armado) (Corporativo)", pricePerHour: 20, minHoursCasa: 6, minHoursEmpresa: 6, insuranceFee: 1 },
  ...
  { id: "recreador", label: "Recreador(a)", pricePerHour: 30, minHoursCasa: 6, minHoursEmpresa: 6, insuranceFee: 1 },
  ...
  { id: "hostess", label: "Hostess/Recepcionista", pricePerHour: 20, minHoursCasa: 6, minHoursEmpresa: 6, insuranceFee: 1 },
  ...
  { id: "confeiteiro-premium", label: "Confeiteiro / Bobo Soda Demanda", pricePerHour: 80, minHoursCasa: 4, minHoursEmpresa: 4, insuranceFee: 1 },
  { id: "sommelier", label: "Sommelier", pricePerHour: 90, minHoursCasa: 4, minHoursEmpresa: 4, insuranceFee: 1 },
] as const;
